  ...
  return (
    ...
    >
      <Tilt
        ...
        className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full  border-b-4 border-zinc-400	"
      >
...
const Collection = () => {
  return (
    <section className="relative w-full mx-auto h-screen bg-primary mb-[200px] ">
      <div
      ...
      >
        ...
        <div className="mt-20 gap-10 w-full grid grid-cols-3">
          {setup.map((e, index) => (
